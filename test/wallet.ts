...
import {
  ApiTransactionDirectionEnum,
  ApiTransactionStatusEnum,
  WalletsDelegationActiveStatusEnum
} from '../models'
...
describe('Cardano wallet API', function () {
          ...
          outputs: [
            {
              ...
              address:
                'addr1v9m7qqkehg8y08wkw0p8qrnkrsqdj4tew78r7vqt0e4rfyg6e628h',
              assets: [] as any[]
            },
            {
              amount: {
              ...
              address:
                'addr1vxk7zajwxrj7d63d857leyr5xjns5eqwu90t7av9s3qansgy3n03h',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxzfrx9fqmr9rksy3d3p5dt4s7kuzvxecptp4g6k6jyjf0c4wqrqv',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9fgg22y8zg9ew0sr8zecem3awlp8y2nkz06pj9rp0jze2g8yaz8s',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxqxrkn4m9gkkw9zjxv0ucclakl9yk0mf58szfnexv6gp4cqd8lmc',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxyh67eruv8lk7j5cd4uxxlwzhh5s37agmq82g8yly8d6ysgvf36v',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8fh0twhfl8asg2umdrghc0atawtlsvgtn4w2em5cdka5nq9htxna',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9jxt6pyruyjp09hcgmfz842cewgd76rft7kc2th7xaq74qfcrflh',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vynncsy67q5gzuextklwhgg7fqesm28lk7k3tryy4j9cmfsepfas7',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxwghnp98zdnqwxhsjccm4w7kcz5u5cazhe6f3dyes4g7pgf6f5lp',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8kjvptz7htc03uck4a6s78cvuetqgwhqyt5kf7mtleta8ce94xxu',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxy82rpx84s58vy74y34gy88lw0x0hvttuap6599nujp3cgdqvwsh',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8twacd3svulf74kxg4us59yrvp3lt4ajvl90w3u8vdjx2cajgkgy',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxwz08f2nd28eagctmpfxzcv8xn5lg8d4wjpx20ypfn93zcs8uucg',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx9n2zkkgc6gqy2j3kkyfxjf27mtm98lx0vnwhj5jz5uasq9yl5hk',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9zsagjclpwam9p6humeg87x7r8r268kf5k8h5kun0sh3rgs7536w',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyjqralj63q5xyw03sxxeyc8svfk3ymrw2gwj79p0p00lxcapajam',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx7r3cy4uanwjgqjyttnymqkqsrt448ezylrkkdvqrjzxzssn75lu',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vydvk9kl2tqf5wkxajalkgf8kemjak3glhrm4d5l99jwhysfqx5ts',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy7qf5ctc8ydaz0d0g8dwy05eq8d4mtenlz377mzpec45sgk3f5q0',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9c36pmak8t8a8ra8jz347rmv3vxxq4mvc3ccmn9aez9glgq5mwq6',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy3f4vhj8xt9x8t93np94uak2kptltuw2spr0a7jy0jnftgzskwy5',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8y20cs4h8n4jcf6fgpkf9yea35r8sawazk7r7rktf9w2hssz5yu7',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v94ywg549gh0zs4g9fmty4tgm0cq5a95lsm29lccpezks3qf9w3hg',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v876apusu8nfs6d6apgmj6vp5lcjjxmlvlc2sj9y98wtv5c7qc2yq',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxyht88xde2nj25wfm63a0c24tvs2xulzpcvvhm4z4sjxsc0rfvah',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v95k6agq60kjdpf9uh68nz32wayqdf7m9zgqzeqc64mdefstkmfj8',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyshpxd63rwpg7l9qt3atsfnf2mgw749zuz9sk5ytk5jtxctw66gt',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy2qapgq2m8f6rawzlh9f9e4haz0h6rxsk4rul6xec29rsc96c9nt',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v946mhp66he3x8vwltpakf9m3k4nrs85k6gpxg8pprhmhyq5n8erd',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyzngcwg46eemhu9uduvu7nwmjhzc5grnzl9dtftmhjf9fc8vqq7a',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8qfgyumu7n0tsje3m9aednwgm9vut79h8l02dr99rtjvssps5qr5',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyhcdseax6mjcrxz2c64p2czmgqtpvzptgtjhdlykm0ppmg8emn7s',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8qafj5c5yms4wcquvq6mznnhv9qdtpemr5y0dw9m885rqs2cjg7e',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v92gawsmqg5qguugclyearf2qrv6m9sjhsy20qdxp7a76dsg6yn5f',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxwpcgf27r7nnwf983zzc8zgh0mgh3jgdhugps7cvuy0mcgyzs9sa',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxe02c3trl78295wmdymgc02ep4l299t80msq4zk70dxtuckl9k29',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8kt5a9fu6emsqwn9pmkzxwf5cws8nnyk72nsseqldt7r2cc40gw2',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxzh0n0kleyazj8uvla92vvxhydwrpmfnsnuq5paa45lk9smr9pxc',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9rw4mn2hlgcvhw96p25r98vgppk2xpyq78f3mrkufwhxncw6a0qs',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy02rescazffxy9447eh3pcgvy22kywdwatmp4ehu2cy5dgtwd2fr',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9csrpk0l9rh5y3xx0qwjpq97ag00cp3qunlgdwmzwfd0nqrqtqny',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxed6d24ug6h5xsvr5prnzsyur5ux38l2cw6rva84a4e9ccm42vm2',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyqysc73p93ecrnea6jx98u09ueuq39kk52z0f57vzl5vjqqzdw3p',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v89tyleg3qxqg00u9qsvmykyy3dfutcl2qsu5wnsm2fj33q5rdr5m',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxq95kjh5yf6t4uy9ytlu5mzp6kgxa3wvszv5fzx99k92hc0d248y',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8mpmyf5fj2hgvfapgwc3g2tvw4revnpn4xy6ezrprsjencrsaudf',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8qmyqyacms90zr5npww4zl3gh5sxe4afmzdzr6temtcw4surwdhx',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy074kt6eytqra6gh58ju70u76n5gujm09q6ej3hqpcw5gc9vhktm',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy3qlm7k4chn3p9zh37u0mpny420n5r7854yujc30lsyf7gk2ppyf',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxv60se24f26v2xex66nnuqa2s2nrr0v3094uk0vwxhkjkc3mwljs',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyuxc75xmzzy7sy955pyz4tqg0ycgttjcv2u39ay929q2yq8h7umy',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx7hsxtpw3vae52avvwy24j4xj7kpcvpxqzs4m24h0r8ngc9e6rd6',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9qw9xflglesswd8prfagn3e3rauu7hyn7cnd6fw7y2ht3gdah3qf',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxu5sa6effs76vgayk9n5wfdaprmwt96g6wrfxaz7nhynncl3a9j2',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vym7k0fkzfr6q6ykvd7wfdn35aqyx6mnewsh0ws2zdh7l5spt00my',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v99wq77g6t2jvmy420r22hqd028s7079p8ssgz45ehxnexqjg5qwx',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy7ptj37j2j09agtqa822fdqpf82e5ws2xtzd0xn8xeygpqu6pvqu',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxztq9lhj9k7v7r3ye930uvpwarc8cps53qjcq0q35t4glcx9a3m7',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy97tuy34tz42jg60dyft9qp89msyn9vsdd730nmemk5s4qzu5tjf',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9qhhts5p86qj9ursda7y22rv5m0mcjsuqdct7gulnfkhps9ysqeg',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy835wr2cgu7ypff304hana5j9c8nuald28ktldn53wzedsxxzwkv',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx8uckm9s4ty0ste2mk6tj77h0pcrfystmrmthns5nls8rqallrvy',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8jdrahgwxyc26ptdtfgm2qrrpath6p5wdhcrqtcj94vkts72czsg',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vyx0myhmrd7dj3l6zkyhmag7shmdd48yhylm34u2lud3pdcehesq2',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vy6sqevluqp7lftl88hup6h4pu3ggeexnwrmqkfvewtvuvsn9ftn5',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vxtk0aguznvjqqatj9cfdx0xhmtp52hqxky87yusjsn34cc7kh3k6',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx48m9dn30hgm840g9s30yyjlv5dsqfh429xn89sskunr4q46q3yd',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v8ecg4npdm76m8gdmnvnze4hukmgn7yy4au5ta7447kh4vq2pkt30',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1vx9j2tk307qzkkzk68x6h57r26fj802g9gja268r8z5umpgnql9fw',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9u6pzee8v733z6cptppjq6wyprztqpp58kzfaz8qypphdsummuyt',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v9fwez477qgc9wm72c78e46q0nvfujcefqklsea4kdn784stk7ufq',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v957kxplc6pq8j7xajm2kcydn3cj8zf3a7u55swysah8ldq6narjd',
              assets: []
            },
            {
              amount: {
              ...
              address:
                'addr1v98d5fszt89zk9fw4jjnuptk67n8z0707v8gqr03c88y8uc7plull',
              assets: []
            }
          ],
    ...
    outputs: [
      {
        ...
        address:
          'addr1q99d7qnpvw53stx5ppave9n2aarwxar552v55p4xnhjy6me59kkfl90wf7f9vlm99fek6e9l5zh65td8jhw63hn9skqq9hd2f7',
        assets: [] as any[]
      },
      {
        amount: {
        ...
        address:
          'addr1q8s2ev94k83lsctwyzj0kklgzlt02hv75z6cjqtpqxlafpq7vjhxlzaazkhgv47za494arh3lqhz997hat2vveuzlvfse80cay',
        assets: []
      }
    ],
    expires_at: {
  ...
  const txRaw = {
    ...
    description: '',
    cborHex:
      ''
  }

  before('Initializing the test cluster ...', async function () {
    walletServer = WalletServer.init(
      `http://${process.env.TEST_WALLET_HOST}:${process.env.TEST_WALLET_PORT}/v2`
    )

    for (let i = 0; i < wallets.length - 1; i++) {
      const w = wallets[i]
      await walletServer.createOrRestoreShelleyWallet(
        w.name,
        w.mnemonic_sentence,
        w.passphrase
      )
  ...
  describe('wallet', function () {
    ...
    it("should throw an 'wallet_already_exist' error", async function () {
      ...
      await expect(
        walletServer.createOrRestoreShelleyWallet(
          w.name,
          w.mnemonic_sentence,
          w.passphrase
        )
        ...
        .and.have.nested.property('response.data.code')
        .equal('wallet_already_exists')
    })

    it('should get a list of wallets', async function () {
      const ls = await walletServer.wallets()
      const ids = ls.map((w) => w.id)
    ...
    it('should get utxo wallet statistics', async function () {
      const w = wallets.find(
        (w) => w.id == '868d04759fd222ac776484888d4bcd462d146772'
      )

      const wallet = await walletServer.getShelleyWallet(w.id)
      const statistics = await wallet.getUtxoStatistics()
    ...
    it('should get a wallet', async function () {
      const w = wallets.find(
        (w) => w.id === '2a793eb367d44a42f658eb02d1004f50c14612fd'
      )
    ...
    it('shuld remove a wallet', async function () {
      const ls = await walletServer.wallets()
      const wallet = ls.find((w) => w.name == 'tangocrypto-wallet')
      await wallet.delete()
      await expect(walletServer.getShelleyWallet(wallet.id))
        .to.eventually.rejectedWith(Error)
        .and.have.nested.property('response.status')
        .equal(404)
    })

    it('should rename a wallet', async function () {
      const w = wallets.find(
        (w) => w.id === '60bb5513e4e262e445cf203db9cf73ba925064d2'
      )
      const name = 'new-name'
    ...
    it('should change a wallet passphrase', async function () {
      ...
      let wallet = await walletServer.getShelleyWallet(w.id)
      const lastUpdatedAt = wallet.passphrase.last_updated_at
  ...
  describe('address', function () {
    ...
    it("should get first wallet's address external verification key", async function () {
      const id = '2a793eb367d44a42f658eb02d1004f50c14612fd'
      const addr =
        'addr_vk1rfx8dy8dh3t04234qu98gcuu9sqenpvzqx506tfwh9c26vd02fwqmx69lx' // external verification address at 0

      const wallet = await walletServer.getShelleyWallet(id)
      const address = await wallet.getAddressExternalVerificationKey(0)
    ...
    it("should get first wallet's stake verification key", async function () {
      const id = '2a793eb367d44a42f658eb02d1004f50c14612fd'
      const addr =
        'stake_vk1jj0une4hu8sjaye6cdw7tft9eynykzk9kccmfadzz4ytcmt9v9hs2k6s7u' // stake address at 0

      const wallet = await walletServer.getShelleyWallet(id)
      const stake = await wallet.getStakeVerificationKey(0)
    ...
    it('should get wallet next unused address', async function () {
      const id = '4ea40ca5323bad2efb77c68ae42e5bb7205ab5e6'
      const addr =
  ...
  describe('stake pool', function () {
    it('should return stake pool ranking list by member rewards', async function () {
      ...
      const pools = await walletServer.getStakePools(stake)
      const rewards = pools.map(
        (p) => p.metrics.non_myopic_member_rewards.quantity
      )
    ...
    it('should estimate delegation fee', async function () {
      ...
      const wallet = await walletServer.getShelleyWallet(w.id)
      const fee = await wallet.estimateDelegationFee()

      expect(fee).deep.equal(delegationFee)
    })

    it('should delegate to stake pool', async function () {
      const pool = (await walletServer.getStakePools()).find(
        (p) =>
          p.id == 'pool1as50x0wtumtyqzs7tceeh5ry0syh8jnvpnuu9wlxswxuv48sw4w'
      )
      const w = wallets.find(
        (w) => w.id == '2a793eb367d44a42f658eb02d1004f50c14612fd'
      )
      ...
      const inputAmount = transaction.inputs
        .map((i) => i.amount.quantity)
        .reduce((a, b) => a + b)
      const outputAmount = transaction.outputs
        .map((o) => o.amount.quantity)
        .reduce((a, b) => a + b)
      const spent = transaction.amount.quantity // fee + deposit
      ...
      if (transaction.status == ApiTransactionStatusEnum.InLedger) {
        ...
        if (wallet.delegation.next.length > 0) {
          const epoch = wallet.delegation.next
            .sort(
              (a, b) => -(a.changes_at.epoch_number - b.changes_at.epoch_number)
            )
            .map((d) => d.changes_at.epoch_number)[0]
    ...
    it('should withdraw wallet rewards', async function () {
      ...
      const wallet = await walletServer.getShelleyWallet(w.id)
      const addresses = (await wallet.getUsedAddresses()).slice(0, 1)
      const amounts = [wallet.getRewardBalance()]
      ...
      const outputAmount = transaction.outputs
        .map((o) => o.amount.quantity)
        .reduce((a, b) => a + b)
      const fee = transaction.fee.quantity
      ...
      if (transaction.status == ApiTransactionStatusEnum.InLedger) {
        await wallet.refresh()
        const newAvailableBalance = wallet.getAvailableBalance() + fee
    ...
    it('should stop delegating', async function () {
      ...
      const outputAmount = transaction.outputs
        .map((o) => o.amount.quantity)
        .reduce((a, b) => a + b)
      const amount = transaction.amount.quantity
      ...
      if (transaction.status == ApiTransactionStatusEnum.InLedger) {
        ...
        const delegation = wallet.getDelegation()
        const rewards = wallet.getRewardBalance()
        expect(rewards).equal(0)
        expect(delegation.active.status).equal(
          WalletsDelegationActiveStatusEnum.NotDelegating
        )
      }
    })
  })
  ...
  describe('transaction', function () {
    ...
    it('should get tx list', async function () {
      ...
      const transactions = await wallet.getTransactions(start, end)
      tx = transactions[0]
      transactions
        .filter((tx) => tx.metadata)
        .forEach((t) => {
          const metadata = Seed.reverseMetadata(t.metadata, 'array')
    ...
    it('should get tx details', async function () {
      ...
      const wallet = await walletServer.getShelleyWallet(w.id)
      const transaction = await wallet.getTransaction(tx.id)
    ...
    it('should get payment fee', async function () {
      const receiver = '9ada973fd29d6b3d096ab361ef5fd082576bdbe3'
      const payeer = '2a793eb367d44a42f658eb02d1004f50c14612fd'

      const rWallet = await walletServer.getShelleyWallet(receiver)
      const addresses = (await rWallet.getUnusedAddresses()).slice(0, 1)
      const amounts = [1000000]

      const wallet = await walletServer.getShelleyWallet(payeer)
      const estimatedFees = await wallet.estimateFee(addresses, amounts)

      expect(estimatedFees).not.undefined
    })

    it('should send a payment transfer', async function () {
      const receiver = '2a793eb367d44a42f658eb02d1004f50c14612fd'
      const payeer = '60bb5513e4e262e445cf203db9cf73ba925064d2'
      const passphrase = 'shelley-small-coins'

      const rWallet = await walletServer.getShelleyWallet(receiver)
      const addresses = (await rWallet.getUsedAddresses()).slice(0, 1)
      const amounts = [1000000]
      ...
      const outputAmount = transaction.outputs
        ...
        .reduce((a, b) => a + b)
      const fee = transaction.fee.quantity
      const spent = output.amount.quantity + fee
      const paid = amounts.reduce((a, b) => a + b)
    ...
    it('should get coin selection', async function () {
      ...
      const addresses = (
        await (
          await walletServer.getShelleyWallet(receiver.id)
        ).getUsedAddresses()
      ).slice(0, 1)
      const amounts = [5000000]
      const coins = await wallet.getCoinSelection(addresses, amounts)

      const inputAmount = coins.inputs
        .map((i) => i.amount.quantity)
        .reduce((a, b) => a + b)
      const outputAmount = coins.outputs
        .map((o) => o.amount.quantity)
        .reduce((a, b) => a + b)
      const changeAmount = coins.change
    ...
    it('should send a offline signed payment transaction', async function () {
      const receiver = '2a793eb367d44a42f658eb02d1004f50c14612fd'
      const payeer = wallets.find(
        (w) => w.id == '60bb5513e4e262e445cf203db9cf73ba925064d2'
      )
      const wallet = await walletServer.getShelleyWallet(payeer.id)
      const addresses = (
        await (
          await walletServer.getShelleyWallet(receiver)
        ).getUnusedAddresses()
      ).slice(0, 1)
      const amounts = [1000000]
      ...
      const txBuild = Seed.buildTransaction(
        ...
        { metadata: metadata, config: LocalCluster }
      )
...
async function waitUntilTxFinish(
  txId: string,
...
async function waitUntilEpoch(epoch: number, server: WalletServer) {
  return new Promise<void>(async (resolve, reject) => {
    const information = { epoch_number: 0 }
    do {
      await delay(1)
      const info = await server.getNetworkInformation()

 ...
 * @export
 */
export const ProxyApiAxiosParamCreator = function (
  ...
  return {
    ...
    async postExternalTransaction(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<InlineResponse2022>
    > {
      const localVarAxiosArgs = await ProxyApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ProxyApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    postExternalTransaction(
      ...
      return ProxyApiFp(configuration)
        .postExternalTransaction(body, options)

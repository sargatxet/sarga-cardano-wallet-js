 ...
 * @export
 */
export const ByronMigrationsApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getByronWalletMigrationInfo: async (
      walletId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling getByronWalletMigrationInfo.'
        )
      }
      const localVarPath = `/byron-wallets/{walletId}/migrations`.replace(
        `{${'walletId'}}`,
    ...
    migrateByronWallet: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
          'Required parameter body was null or undefined when calling migrateByronWallet.'
        )
      }
      // verify required parameter 'walletId' is not null or undefined
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling migrateByronWallet.'
        )
      }
      const localVarPath = `/byron-wallets/{walletId}/migrations`.replace(
        `{${'walletId'}}`,
...
export const ByronMigrationsApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await ByronMigrationsApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ByronMigrationsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getByronWalletMigrationInfo(
      ...
      return ByronMigrationsApiFp(configuration)
        .getByronWalletMigrationInfo(walletId, options)
...
export class ByronMigrationsApi extends BaseAPI {
  ...
  public getByronWalletMigrationInfo(walletId: string, options?: any) {
    return ByronMigrationsApiFp(this.configuration)
      .getByronWalletMigrationInfo(walletId, options)

 ...
 * @export
 */
export const ByronCoinSelectionsApiAxiosParamCreator = function (
    ...
    byronSelectCoins: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
          'Required parameter body was null or undefined when calling byronSelectCoins.'
        )
      }
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling byronSelectCoins.'
        )
      }
      const localVarPath =
        `/byron-wallets/{walletId}/coin-selections/random`.replace(
          `{${'walletId'}}`,
 ...
 * @export
 */
export const ByronCoinSelectionsApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    > {
      const localVarAxiosArgs = await ByronCoinSelectionsApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ByronCoinSelectionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    byronSelectCoins(
      ...
      return ByronCoinSelectionsApiFp(configuration)
        .byronSelectCoins(body, walletId, options)
...
export class ByronCoinSelectionsApi extends BaseAPI {
  ...
  public byronSelectCoins(body: Body19, walletId: string, options?: any) {
    return ByronCoinSelectionsApiFp(this.configuration)
      .byronSelectCoins(body, walletId, options)

 ...
 * @export
 */
export const ByronTransactionsApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteByronTransaction: async (
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling deleteByronTransaction.'
        )
      }
      ...
      if (transactionId === null || transactionId === undefined) {
        throw new RequiredError(
          'transactionId',
          'Required parameter transactionId was null or undefined when calling deleteByronTransaction.'
        )
      }
      const localVarPath =
    ...
    getByronTransaction: async (
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling getByronTransaction.'
        )
      }
      // verify required parameter 'transactionId' is not null or undefined
      if (transactionId === null || transactionId === undefined) {
        throw new RequiredError(
          'transactionId',
          'Required parameter transactionId was null or undefined when calling getByronTransaction.'
        )
      }
      const localVarPath =
        `/byron-wallets/{walletId}/transactions/{transactionId}`
    ...
    listByronTransactions: async (
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling listByronTransactions.'
        )
      }
      const localVarPath = `/byron-wallets/{walletId}/transactions`.replace(
        `{${'walletId'}}`,
    ...
    postByronTransaction: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
          'Required parameter body was null or undefined when calling postByronTransaction.'
        )
      }
      // verify required parameter 'walletId' is not null or undefined
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling postByronTransaction.'
        )
      }
      const localVarPath = `/byron-wallets/{walletId}/transactions`.replace(
        `{${'walletId'}}`,
    ...
    postByronTransactionFee: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
          'Required parameter body was null or undefined when calling postByronTransactionFee.'
        )
      }
      // verify required parameter 'walletId' is not null or undefined
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling postByronTransactionFee.'
        )
      }
      const localVarPath = `/byron-wallets/{walletId}/payment-fees`.replace(
        `{${'walletId'}}`,
        encodeURIComponent(String(walletId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
 ...
 * @export
 */
export const ByronTransactionsApiFp = function (configuration?: Configuration) {
  return {
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Forget pending Byron transaction. Importantly, a transaction, when sent, cannot be cancelled. One can only request forgetting about it in order to try spending (concurrently) the same UTxO in another transaction. But, the transaction may still show up later in a block and therefore, appear in the wallet.
     * @summary Forget
    ...
    > {
      const localVarAxiosArgs = await ByronTransactionsApiAxiosParamCreator(
        configuration
    ...
    async getByronTransaction(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<InlineResponse2021>
    > {
      const localVarAxiosArgs = await ByronTransactionsApiAxiosParamCreator(
        configuration
    ...
    async postByronTransactionFee(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<InlineResponse202>
    > {
      const localVarAxiosArgs = await ByronTransactionsApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ByronTransactionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteByronTransaction(
      ...
      return ByronTransactionsApiFp(configuration)
        .deleteByronTransaction(walletId, transactionId, options)
 ...
 * @extends {BaseAPI}
 */
export class ByronTransactionsApi extends BaseAPI {
  /**
   * <p align=\"right\">status: <strong>stable</strong></p>  Forget pending Byron transaction. Importantly, a transaction, when sent, cannot be cancelled. One can only request forgetting about it in order to try spending (concurrently) the same UTxO in another transaction. But, the transaction may still show up later in a block and therefore, appear in the wallet.
   * @summary Forget
   * @param {string} walletId
   ...
   */
  public deleteByronTransaction(
    walletId: string,
    transactionId: string,
    options?: any
  ) {
    return ByronTransactionsApiFp(this.configuration)
      .deleteByronTransaction(walletId, transactionId, options)
   ...
   * @memberof ByronTransactionsApi
   */
  public postByronTransaction(body: Body18, walletId: string, options?: any) {
    return ByronTransactionsApiFp(this.configuration)
      .postByronTransaction(body, walletId, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ByronTransactionsApi
   */
  public postByronTransactionFee(
    body: Body17,
    walletId: string,
    options?: any
  ) {

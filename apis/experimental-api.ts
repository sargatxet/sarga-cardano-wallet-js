 ...
 * @export
 */
export const ExperimentalApiAxiosParamCreator = function (
    ...
    signMetadata: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          'body',
          'Required parameter body was null or undefined when calling signMetadata.'
        )
      }
      ...
      if (walletId === null || walletId === undefined) {
        throw new RequiredError(
          'walletId',
          'Required parameter walletId was null or undefined when calling signMetadata.'
        )
      }
      ...
      if (role === null || role === undefined) {
        throw new RequiredError(
          'role',
          'Required parameter role was null or undefined when calling signMetadata.'
        )
      }
      ...
      if (index === null || index === undefined) {
        throw new RequiredError(
          'index',
          'Required parameter index was null or undefined when calling signMetadata.'
        )
      }
...
export const ExperimentalApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await ExperimentalApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ExperimentalApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    signMetadata(
      ...
      return ExperimentalApiFp(configuration)
        .signMetadata(body, walletId, role, index, options)
...
export class ExperimentalApi extends BaseAPI {
  ...
  public signMetadata(
    ...
    return ExperimentalApiFp(this.configuration)
      .signMetadata(body, walletId, role, index, options)
